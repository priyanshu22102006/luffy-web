  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 right-20 w-24 h-24 bg-sunset-400/20 rounded-full animate-float" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 right-10 w-16 h-16 bg-white/15 rounded-full animate-float" style={{ animationDelay: '2s' }}></div>
      </div>
          ...
          <div className="lg:w-1/2 flex justify-center">
            <div className="relative">
              <div className="w-80 h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden border-8 border-white/20 shadow-2xl animate-float">
                <img 
                  src="https://images.unsplash.com/photo-1501286353178-1ec881214838?w=400&h=400&fit=crop&crop=center"
                  alt="Monkey D. Luffy - Adventurous spirit"
              ...
              <div className="absolute -bottom-6 -left-6 w-12 h-12 bg-white/30 rounded-full animate-wave" style={{ animationDelay: '1s' }}></div>
            </div>
          </div>
        </div>
      </div>
