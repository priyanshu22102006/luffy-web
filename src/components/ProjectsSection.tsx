        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-1 gap-8 max-w-2xl mx-auto">
            {currentProjects.map((project, index) => (
              <Card key={project.title} className="hover:shadow-xl transition-all duration-300 border-l-4 border-green-500">
                <CardHeader>
                ...
                <CardContent>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech, idx) => (
                      <span key={idx} className="px-3 py-1 bg-ocean-100 text-ocean-800 rounded-full text-sm">
                        {tech}
                      </span>
                    ))}
                  </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {upcomingProjects.map((project, index) => (
              <Card key={project.title} className="hover:shadow-lg transition-all duration-300 group hover:scale-105">
